...
public abstract class AbstractBootstrapValueBox<W extends Widget & HasValue<T> & HasEnabled, T>
		extends Composite {
	...
	public interface ViewUiBinder extends
			UiBinder<HTMLPanel, AbstractBootstrapValueBox> {
	}
	...
	protected native void addMask(Element element, String mask,
			boolean maskReverse)/*-{
