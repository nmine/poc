...
public class ApplicationController {
	...
	// http://localhost:8080/mysample/articles/details
	@RequestMapping(value = "/details", method = RequestMethod.GET)
	public String Articlesdetails(Model model) {
		// initData();
		return "articles/details";
	}

	@RequestMapping(value = "/detailsCreate", method = RequestMethod.POST)
	public @ResponseBody String createSmartphone(
			@ModelAttribute(value = "person") Person person, BindingResult result) {
		String returnText;
		if (!result.hasErrors()) {
	...
	public String sendMessage(Model model, @Valid MailMessage mailMessage,
	...
	private void prepareModelForView(Model model, boolean addNewComment,
			boolean addNewMailMessage) {
