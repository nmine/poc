...
public class BootstrapTextBox extends AbstractBootstrapValueBox<TextBox, String> implements HasKeyUpHandlers {
	...
	getValuebox().addKeyDownHandler(new KeyDownHandler() {
		...
		// very first time you are in a textbox and press enter, it refreshes the page.
	...
	return super.getValue() != null && super.getValue().trim().length() > 0 ? super.getValue().trim() : null;
    }
